...
const Admin = () => {
    ...
    const handleDownloadExcel = () => {
        ...
        const worksheet = XLSX.utils.json_to_sheet([headers, ...details.map(detail => [
            ...
            detail.netAmount,
            detail.supervisor,
            detail.verification_adean ? 'Verified' : 'Not Verified',
            detail.verification_adean ? 'Verified' : 'Not Verified'
        ])]);
        ...
        try {
            ...
            setDetails(prevDetails => 
                prevDetails.map(detail =>
                    detail._id === id ? { ...detail, verification_adean: true } : detail
                )
            );
                            ...
                            <tr key={detail._id}>
                                ...
                                <td>
                                    {/* {detail.verification_hod && (
                                        <button onClick={() => handleVerificationToggle(detail._id)} disabled={detail.verification_adean}>
                                            Verify
                                        </button>
                                    )} */}
                                    {
                                ...
                                {/* <td>{detail.verification_adean ? 'Verified' : 'Not Verified'}</td> */}
                            </tr>
                        ))}
                    </tbody>
                </table>
